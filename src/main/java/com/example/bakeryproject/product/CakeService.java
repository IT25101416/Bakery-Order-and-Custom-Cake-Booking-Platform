...
public class CakeService {
    ...
    public void addCake(Cake cake) {
        com.example.bakeryproject.common.FileUtil.saveLine(FILE_PATH, cake.toFileString());
    }

    public List<Cake> getAllCakes() {
        List<String> lines = com.example.bakeryproject.common.FileUtil.readLines(FILE_PATH);
    ...
    public Cake findCakeByName(String cakeName) {
        ...
        for (Cake cake : getAllCakes()) {
            if (cake.getCakeName() != null && cake.getCakeName().equalsIgnoreCase(cakeName.trim())) {
                return cake;
            }
        }
        return null;
    ...
    public void updateCake(Cake updatedCake) {
        ...
        com.example.bakeryproject.common.FileUtil.overwriteFile(FILE_PATH, updatedLines);
    }
